  ...
  <el-container style="height: 850px; border: 1px solid #eee">
    <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
      <el-menu :default-openeds="['1', '0']">
        <el-submenu index="1">
          <template slot="title">
            <i class="el-icon-s-home" @click="shouy"></i
            ><span @click="shouy">首页</span></template
          >
        </el-submenu>
        <el-submenu index="2">
          <template slot="title">
            <i class="el-icon-s-goods" @click="tiaoz"></i
            ><span @click="tiaoz">商品管理</span></template
          >
        </el-submenu>
         <el-submenu index="3">
          <template slot="title">
    ...
    <el-container>
      <el-header>
        <el-row>
          ...
          <el-col :span="2"><div class="table">用户管理</div></el-col>
          <el-col :span="19"><div class="table">&nbsp;</div></el-col>
          <el-col :span="2">
            <!-- 头像下拉菜单 -->
...
export default {
  ...
  methods: {
    ...
    confirmEdit() {
      ...
      this.tableData[editdata].sex = this.Form.sex;
